    ...
    <section className="grid grid-cols-1 md:grid-cols-2">
      {items.map((item, index) => (
        ...
        >
          ...
          <button className="mt-6 border border-[#1A1A1A] text-[#1A1A1A] w-[180px] h-[48px] rounded-[6px] flex items-center justify-center text-[16px] lg:text-[20px] font-aeonik-regular">
            Get in Touch
          </button>
        </div>
      ))}
