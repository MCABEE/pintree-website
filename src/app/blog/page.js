...
export default function Page() {
  ...
  return (
    <>
      <Navbar />
      <div className="bg-white w-full min-h-screen pt-[140px] 2xl:pt-[190px] px-[180px] 2xl:px-[240px]">
        <div className="text-center  ">
          <h1 className="text-[86px] 2xl:text-[96px] text-[#1A1A1A] font-aeonik-medium ">
            Pintree Blog
          </h1>
          <p className="text-[20px] 2xl:text-[24px] text-[#1A1A1A] font-aeonik-regular leading-[140%] ">
            Insights, updates, and stories that show how Pintree evolves,
            improves, <br /> and empowers its community.
          </p>
        </div>

        <div className="mt-[169px] 2xl:mt-[189px]">
          <p className="text-[#000000] text-[20px] 2xl:text-[24px]  font-aeonik-regular">
            27 November 2025, Thu
          </p>

          <h2 className="mt-[39px] text-[56px] 2xl:text-[66px]  font-aeonik-regular leading-[120%] text-[#0C0C0C] ">
          ...
          <p className="text-[#333333] font-aeonik-regular text-[20px] 2xl:text-[24px] leading-[140%]  mt-[45px]">
          ...
          <button className="mt-[39px] w-[169px] *:2xl:w-[192px] h-[54px] 2xl:h-[64px] border border-[#1A1A1A] rounded-[22px] 2xl:rounded-[32px] text-[20px] 2xl:text-[24px] font-aeonik-regular text-[#333333] ">
            Read More
          </button>
        </div>

        <div className="  mt-[80px] 2xl:mt-[100px] ">
          <h3 className="text-[30px] 2xl:text-[40px] font-aeonik-regular text-[#0C0C0C] ">
            More From Pintree
          </h3>
          ...
          <div className="flex flex-col xl:flex-row gap-[40px] pt-[43px]">
            ...
            <div className="flex flex-col w-full xl:w-[60%]">
              <p className="text-[#000000] text-[18px] 2xl:text-[20px] ">
                27 November 2025, Thu
              </p>

              <h4 className="text-[30px] 2xl:text-[40px] font-aeonik-regular mt-[14px] leading-[120%] text-[#0C0C0C] ">
                How Pintree’s discovery feed helps you find what truly matters
              </h4>

              <p className="text-[#333333] font-aeonik-regular text-[16px] 2xl:text-[20px] leading-[140%] pt-1 ">
                On Pintree, your feed evolves with your interests, not random
                trends.
                <br />
              ...
              <button className="mt-[28px] w-[100px] 2x:w-[114px] h-[38px] 2xl:h-[48px] border border-[#1A1A1A] rounded-[18px] 2xl:rounded-[24px] text-[#333333] text-[14px] 2xl:text-[16px] ">
                Read More
              </button>
            </div>
          </div>
