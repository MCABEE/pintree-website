          ...
          <div className="w-full max-w-2xl ">
            ...
            <form className="space-y-7 mt-[27px] sm:mt-[59px] text-[#333333] text-[20px] font-aeonik-regular px-4">
              ...
              <div>
                ...
                <input
                  type="text"
                  className="w-full border border-[#0C0C0C] rounded-[4px] px-[25px] h-[48px]  text-[#333333] text-[16px] font-aeonik-regular outline-none"
              ...
              <div>
                ...
                <textarea
                  className="w-full px-[25px] border border-[#0C0C0C] rounded-[4px] h-[128px] pt-[16px] text-[#333333] text-[16px] font-aeonik-regular outline-none"
              ...
              <div>
                ...
                <button
                  type="button"
                  className="bg-[#0453F1] text-white w-[104px] 2xl:w-[144px] h-[48px]  rounded-[4px] text-[16px]  font-aeonik-regular"
                >
                  Upload File
                </button>
              ...
              <div>
                ...
                <p className="text-[#333333] font-aeonik-regular text-[16px] leading-[140%]  ">
                  ...
                  acknowledge that Pintree will handle my data in accordance
              ...
              <button
                type="submit"
                className="w-full bg-[#0453F1] text-white  py-[12px]  rounded-[4px] text-[16px] font-aeonik-medium "
              >
                Submit
              </button>
            </form>
